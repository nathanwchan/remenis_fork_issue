...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique('core_user', ['facebook_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'User', fields ['facebook_id']
        db.delete_unique('core_user', ['facebook_id'])

        # Adding field 'User.id'
        db.add_column('core_user', 'id',
                      self.gf('django.db.models.fields.AutoField')(default=0, primary_key=True),
                      keep_default=False)


        # Changing field 'User.facebook_id'
        db.alter_column('core_user', 'facebook_id', self.gf('django.db.models.fields.BigIntegerField')())
    ...
    models = {
        ...
        'core.user': {
            ...
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
            'facebook_id': ('django.db.models.fields.BigIntegerField', [], {'default': '0', 'primary_key': 'True'}),
